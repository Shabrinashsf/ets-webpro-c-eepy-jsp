...
<main class="flex-1 flex justify-center items-center w-full">
    <div class="flex flex-col justify-center items-center bg-white p-8 rounded-2xl">
        ...
        <form action="<%= request.getContextPath() %>/logincheck" method="post" class="flex flex-col justify-center items-center">
            <div class="mb-2">
        ...
        <div>
            <p class="pt-4">Don't have an account? <a href="${pageContext.request.contextPath}/register/register.jsp" class="text-[#78b3ce]">Sign up</a></p>
        </div>
    </div>
</main>
